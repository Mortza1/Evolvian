      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="glass rounded-lg p-4">
          <div className="text-2xl font-bold text-[#6366F1] mb-1">
            {employees.reduce((acc, e) => acc + (e.evolutions || 0), 0)}
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
                ...
                <span>{Math.min((employee.tasksCompleted % 10) * 10, 100)}%</span>
              </div>
              <div className="w-full h-2 bg-[#020617]/50 rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: `${Math.min((employee.tasksCompleted % 10) * 10, 100)}%` }}
                ></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-[#020617]/30 rounded-lg p-2 text-center">
                <div className="text-lg font-bold text-[#6366F1]">{employee.evolutions || 0}</div>
